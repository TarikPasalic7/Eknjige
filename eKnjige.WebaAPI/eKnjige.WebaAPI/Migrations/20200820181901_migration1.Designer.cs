...
namespace eKnjige.WebaAPI.Migrations
{
    ...
    [Migration("20200820181901_migration1")]
            ...
            modelBuilder.Entity("eKnjige.WebaAPI.Autor", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AutorID = 1,
                            Godiste = new DateTime(2020, 8, 20, 20, 19, 0, 976, DateTimeKind.Local).AddTicks(3171),
                            Ime = "Ivo",
                            Prezime = "Andric"
                        },
                        new
                        {
                            AutorID = 2,
                            Godiste = new DateTime(2020, 8, 20, 20, 19, 0, 979, DateTimeKind.Local).AddTicks(4033),
                            Ime = "George",
                            Prezime = "Martin"
                        },
                        new
                        {
                            AutorID = 3,
                            Godiste = new DateTime(2020, 8, 20, 20, 19, 0, 979, DateTimeKind.Local).AddTicks(4142),
                            Ime = "Albert",
                            Prezime = "Camus"
                        });
                });
            ...
            modelBuilder.Entity("eKnjige.WebaAPI.Klijent", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            KlijentID = 1,
                            DatumRodenja = new DateTime(2020, 8, 20, 20, 19, 0, 979, DateTimeKind.Local).AddTicks(9847),
                        ...
                        {
                            KlijentID = 3,
                            DatumRodenja = new DateTime(2020, 8, 20, 20, 19, 0, 980, DateTimeKind.Local).AddTicks(4088),
            ...
            modelBuilder.Entity("eKnjige.WebaAPI.Komentar", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            KomentarId = 1,
                            DatumKomentara = new DateTime(2020, 8, 20, 20, 19, 0, 981, DateTimeKind.Local).AddTicks(4958),
                            EKnjigaID = 3,
                            KlijentID = 3,
                            komentar = "Komentar 1"
                        },
                        ...
                        {
                            KomentarId = 2,
                            DatumKomentara = new DateTime(2020, 8, 20, 20, 19, 0, 981, DateTimeKind.Local).AddTicks(7403),
                            EKnjigaID = 3,
                            KlijentID = 3,
                            komentar = "Komentar 2"
                        },
                        ...
                        {
                            KomentarId = 3,
                            DatumKomentara = new DateTime(2020, 8, 20, 20, 19, 0, 981, DateTimeKind.Local).AddTicks(7486),
                            EKnjigaID = 1,
                            KlijentID = 3,
                            komentar = "Komentar"
                        });
